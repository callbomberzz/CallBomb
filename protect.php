...
<html lang=en>
<head>
<title>Protect Number - Protect Number Online</title>
...
<center>
<h1> <strong>PROTECT YOUR NUMBER PERMANENTLY</strong>&nbsp;</h1>
</center>
</div>
<div class=container>
...
<input type="text" name="name" class=form-control oninput="handleValueChange()" id="textbox_id"  placeholder="Enter Your Name" required>
</div>
<br>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <img src="./images/tick.png " style="width: 100px; height:100px">
                          <h2>Thankyou</h2>
                          <p ><span id="result"></span> your number is protected</p>
      </div>
...
<i class="fa fa-bomb" aria-hidden=true></i>&nbsp;Sms Number</b></a><br><br>
...
<div class="panel panel-success">
<div class=panel-heading><b><i class="fa fa-bomb" aria-hidden=true></i>&nbsp;What Is Protect Your Number?</b></div>
<div class=panel-body>
<p>
It is protection tool which will work only on CallBomber.
</p>
</div>
</div>
